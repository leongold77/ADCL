...
% FULLDIFF_KB Total derivative wrt time, not just partial derivatives from diff
%
% Note: The version called "fulldiff.m" that is available on the MATHWORKS
% website will give errors. This version uses "symvar" instead of
% "findsym", which avoids that error. (Most of this code was written
% by Tim Jorris, as noted later in the comments.)
%  - Katie Byl, UCSB, 2025
%
%  fulldiff(function)
